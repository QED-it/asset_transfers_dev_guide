...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QedItAssetTransfers.GetBlocksRequest();
  });
  ...
  describe('GetBlocksRequest', function() {
    it('should create an instance of GetBlocksRequest', function() {
      // uncomment below and update the code to test GetBlocksRequest
      //var instance = new QedItAssetTransfers.GetBlocksRequest();
