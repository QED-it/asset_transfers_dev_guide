...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QedItAssetTransfers.ExportWalletResponse();
  });
  ...
  describe('ExportWalletResponse', function() {
    it('should create an instance of ExportWalletResponse', function() {
      // uncomment below and update the code to test ExportWalletResponse
      //var instance = new QedItAssetTransfers.ExportWalletResponse();
      //expect(instance).to.be.a(QedItAssetTransfers.ExportWalletResponse);
    });
