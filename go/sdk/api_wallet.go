 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param getActivityRequest
@return GetActivityResponse
*/
func (a *WalletApiService) WalletGetActivityPost(ctx context.Context, getActivityRequest GetActivityRequest) (GetActivityResponse, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Post")
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  GetActivityResponse
	)
	...
	// body params
	localVarPostBody = &getActivityRequest
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
