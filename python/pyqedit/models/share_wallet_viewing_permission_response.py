...
class ShareWalletViewingPermissionResponse(object):
    ...
    def __init__(self):  # noqa: E501
        """ShareWalletViewingPermissionResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShareWalletViewingPermissionResponse):
            return False
