...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QedItAssetTransfers.GetNewAddressResponse();
  });
  ...
  describe('GetNewAddressResponse', function() {
    it('should create an instance of GetNewAddressResponse', function() {
      // uncomment below and update the code to test GetNewAddressResponse
      //var instance = new QedItAssetTransfers.GetNewAddressResponse();
      //expect(instance).to.be.a(QedItAssetTransfers.GetNewAddressResponse);
    });
