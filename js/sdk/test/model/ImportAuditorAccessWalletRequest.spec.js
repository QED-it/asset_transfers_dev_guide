...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QedItAssetTransfers.ImportAuditorAccessWalletRequest();
  });
  ...
  describe('ImportAuditorAccessWalletRequest', function() {
    it('should create an instance of ImportAuditorAccessWalletRequest', function() {
      // uncomment below and update the code to test ImportAuditorAccessWalletRequest
      //var instance = new QedItAssetTransfers.ImportAuditorAccessWalletRequest();
      //expect(instance).to.be.a(QedItAssetTransfers.ImportAuditorAccessWalletRequest);
    });
