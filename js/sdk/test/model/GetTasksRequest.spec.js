...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QedItAssetTransfers.GetTasksRequest();
  });
  ...
  describe('GetTasksRequest', function() {
    it('should create an instance of GetTasksRequest', function() {
      // uncomment below and update the code to test GetTasksRequest
      //var instance = new QedItAssetTransfers.GetTasksRequest();
      //expect(instance).to.be.a(QedItAssetTransfers.GetTasksRequest);
    });
