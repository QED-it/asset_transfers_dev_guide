...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QedItAssetTransfers.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new QedItAssetTransfers.ErrorResponse();
      //expect(instance).to.be.a(QedItAssetTransfers.ErrorResponse);
    });
