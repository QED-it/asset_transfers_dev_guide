...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QedItAssetTransfers.GetActivityRequest();
  });
  ...
  describe('GetActivityRequest', function() {
    it('should create an instance of GetActivityRequest', function() {
      // uncomment below and update the code to test GetActivityRequest
      //var instance = new QedItAssetTransfers.GetActivityRequest();
      //expect(instance).to.be.a(QedItAssetTransfers.GetActivityRequest);
    });
