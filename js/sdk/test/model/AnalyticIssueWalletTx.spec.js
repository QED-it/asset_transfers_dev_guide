...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QedItAssetTransfers.AnalyticIssueWalletTx();
  });
  ...
  describe('AnalyticIssueWalletTx', function() {
    it('should create an instance of AnalyticIssueWalletTx', function() {
      // uncomment below and update the code to test AnalyticIssueWalletTx
      //var instance = new QedItAssetTransfers.AnalyticIssueWalletTx();
      //expect(instance).to.be.a(QedItAssetTransfers.AnalyticIssueWalletTx);
    });
    ...
    it('should have the property issuedBySelf (base name: "issued_by_self")', function() {
      // uncomment below and update the code to test the property issuedBySelf
      //var instance = new QedItAssetTransfers.AnalyticIssueWalletTx();
      //expect(instance).to.be();
    });
