...
(function(root, factory) {
  ...
  describe('Rule', function() {
    it('should create an instance of Rule', function() {
      ...
      //var instane = new QedItAssetTransfers.Rule();
    ...
    it('should have the property canIssueAnythingConfidentially (base name: "can_issue_anything_confidentially")', function() {
      // uncomment below and update the code to test the property canIssueAnythingConfidentially
      //var instane = new QedItAssetTransfers.Rule();
      //expect(instance).to.be();
    });
