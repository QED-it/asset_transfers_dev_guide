...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QedItAssetTransfers.UnlockWalletRequest();
  });
  ...
  describe('UnlockWalletRequest', function() {
    it('should create an instance of UnlockWalletRequest', function() {
      // uncomment below and update the code to test UnlockWalletRequest
      //var instance = new QedItAssetTransfers.UnlockWalletRequest();
      //expect(instance).to.be.a(QedItAssetTransfers.UnlockWalletRequest);
    });
