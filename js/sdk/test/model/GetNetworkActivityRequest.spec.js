...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QedItAssetTransfers.GetNetworkActivityRequest();
  });
  ...
  describe('GetNetworkActivityRequest', function() {
    it('should create an instance of GetNetworkActivityRequest', function() {
      // uncomment below and update the code to test GetNetworkActivityRequest
      //var instance = new QedItAssetTransfers.GetNetworkActivityRequest();
      //expect(instance).to.be.a(QedItAssetTransfers.GetNetworkActivityRequest);
    });
