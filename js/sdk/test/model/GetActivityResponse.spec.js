...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QedItAssetTransfers.GetActivityResponse();
  });
  ...
  describe('GetActivityResponse', function() {
    it('should create an instance of GetActivityResponse', function() {
      // uncomment below and update the code to test GetActivityResponse
      //var instance = new QedItAssetTransfers.GetActivityResponse();
      //expect(instance).to.be.a(QedItAssetTransfers.GetActivityResponse);
    });
