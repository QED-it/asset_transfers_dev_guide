...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QedItAssetTransfers.IssueAssetRequest();
  });
  ...
  describe('IssueAssetRequest', function() {
    it('should create an instance of IssueAssetRequest', function() {
      // uncomment below and update the code to test IssueAssetRequest
      //var instane = new QedItAssetTransfers.IssueAssetRequest();
      //expect(instance).to.be.a(QedItAssetTransfers.IssueAssetRequest);
    });
    ...
    it('should have the property clearValue (base name: "clear_value")', function() {
      // uncomment below and update the code to test the property clearValue
      //var instane = new QedItAssetTransfers.IssueAssetRequest();
      //expect(instance).to.be();
    });
