...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QedItAssetTransfers.GetWalletActivityResponse();
  });
  ...
  describe('GetWalletActivityResponse', function() {
    it('should create an instance of GetWalletActivityResponse', function() {
      // uncomment below and update the code to test GetWalletActivityResponse
