...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QedItAssetTransfers.GenerateWalletRequest();
  });
  ...
  describe('GenerateWalletRequest', function() {
    it('should create an instance of GenerateWalletRequest', function() {
      // uncomment below and update the code to test GenerateWalletRequest
      //var instance = new QedItAssetTransfers.GenerateWalletRequest();
      //expect(instance).to.be.a(QedItAssetTransfers.GenerateWalletRequest);
    });
