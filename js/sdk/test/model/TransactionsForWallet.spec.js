...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QedItAssetTransfers.TransactionsForWallet();
  });
  ...
  describe('TransactionsForWallet', function() {
    it('should create an instance of TransactionsForWallet', function() {
      // uncomment below and update the code to test TransactionsForWallet
      //var instance = new QedItAssetTransfers.TransactionsForWallet();
      //expect(instance).to.be.a(QedItAssetTransfers.TransactionsForWallet);
    });
