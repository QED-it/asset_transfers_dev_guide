...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QedItAssetTransfers.AnalyticsPublicIssuanceDescription();
  });
  ...
  describe('AnalyticsPublicIssuanceDescription', function() {
    it('should create an instance of AnalyticsPublicIssuanceDescription', function() {
      // uncomment below and update the code to test AnalyticsPublicIssuanceDescription
