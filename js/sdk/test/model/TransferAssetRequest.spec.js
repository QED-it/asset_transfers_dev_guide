...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QedItAssetTransfers.TransferAssetRequest();
  });
  ...
  describe('TransferAssetRequest', function() {
    it('should create an instance of TransferAssetRequest', function() {
      // uncomment below and update the code to test TransferAssetRequest
      //var instane = new QedItAssetTransfers.TransferAssetRequest();
