...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QedItAssetTransfers.TaskActionRequest();
  });
  ...
  describe('TaskActionRequest', function() {
    it('should create an instance of TaskActionRequest', function() {
      // uncomment below and update the code to test TaskActionRequest
      //var instance = new QedItAssetTransfers.TaskActionRequest();
      //expect(instance).to.be.a(QedItAssetTransfers.TaskActionRequest);
    });
