...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QedItAssetTransfers.GetPublicKeyResponse();
  });
  ...
  describe('GetPublicKeyResponse', function() {
    it('should create an instance of GetPublicKeyResponse', function() {
      ...
      //var instance = new QedItAssetTransfers.GetPublicKeyResponse();
      //expect(instance).to.be.a(QedItAssetTransfers.GetPublicKeyResponse);
    });
