...
(function(root, factory) {
  ...
  describe('NodeApi', function() {
    describe('nodeApproveTaskPost', function() {
      it('should call nodeApproveTaskPost successfully', function(done) {
        //uncomment below and update the code to test nodeApproveTaskPost
        //instance.nodeApproveTaskPost(function(error) {
    ...
    describe('nodeCancelTaskPost', function() {
      it('should call nodeCancelTaskPost successfully', function(done) {
        //uncomment below and update the code to test nodeCancelTaskPost
        //instance.nodeCancelTaskPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
