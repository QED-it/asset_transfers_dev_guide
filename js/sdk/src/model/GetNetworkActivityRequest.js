...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QedItAssetTransfers.GetNetworkActivityRequest = factory(root.QedItAssetTransfers.ApiClient);
  }
  ...
  /**
   * The GetNetworkActivityRequest model module.
   * @module model/GetNetworkActivityRequest
   * @version 1.2.0
   */
  ...
  /**
   * Constructs a <code>GetNetworkActivityRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetNetworkActivityRequest} obj Optional instance to populate.
   * @return {module:model/GetNetworkActivityRequest} The populated <code>GetNetworkActivityRequest</code> instance.
   */
