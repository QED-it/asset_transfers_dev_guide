...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AnalyticsOutputDescription', 'model/AnalyticsSpendDescription'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AnalyticsOutputDescription'), require('./AnalyticsSpendDescription'));
  } else {
    // Browser globals (root is window)
    if (!root.QeditAssetTransfers) {
      root.QeditAssetTransfers = {};
    }
    root.QeditAssetTransfers.AnalyticsTransferTx = factory(root.QeditAssetTransfers.ApiClient, root.QeditAssetTransfers.AnalyticsOutputDescription, root.QeditAssetTransfers.AnalyticsSpendDescription);
  }
