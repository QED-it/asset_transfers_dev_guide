...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrderEnum', 'model/Result', 'model/TaskType'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrderEnum'), require('./Result'), require('./TaskType'));
  } else {
    // Browser globals (root is window)
    if (!root.QeditAssetTransfers) {
      root.QeditAssetTransfers = {};
    }
    root.QeditAssetTransfers.GetTasksRequest = factory(root.QeditAssetTransfers.ApiClient, root.QeditAssetTransfers.OrderEnum, root.QeditAssetTransfers.Result, root.QeditAssetTransfers.TaskType);
  }
}(this, function(ApiClient, OrderEnum, Result, TaskType) {
  'use strict';
