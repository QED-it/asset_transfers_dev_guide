...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.walletGetActivityPostWithHttpInfo = function(getWalletActivityRequest) {
     ...
     */
    this.walletGetActivityPost = function(getWalletActivityRequest) {
      return this.walletGetActivityPostWithHttpInfo(getWalletActivityRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
